...
setup(
    name="DiscordEconomy",
    version="1.3.6",
    description="Discord.py, other libs(hikari etc.), and forks(pycord, nextcord etc.) extension to create economy "
    ...
    install_requires=["aiosqlite", "aiohttp", "motor", "dnspython", "nest-asyncio"],
)
